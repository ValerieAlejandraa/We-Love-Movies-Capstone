//knex is imported in connection file
...
function playingInTheaters(){
  return knex("movies as m")//left table
    .join("movies_theaters as mt", "mt.movie_id", "m.movie_id") //right table
    .distinct("m.*")//no duplicate values in columns 
